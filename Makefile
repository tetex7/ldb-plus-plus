...
$(LEX61): $(O_FILES)
	@$(PRINT) "$(GREEN)Linking lex61 file:  $(BLUE)$@ $(NO_COL)\n"
	$(V)$(CXX) -shared $(OPTFLAGS) -o $(BUILD_DIR)/$(LEX61) $(O_FILES) $(GCCFLAG) $(LIBS) $(LDFLAGS) $(EXTRA_LDFLAGS)
	$(V)$(PY3) ./$(SCRTPTS)/get_file_size $(BUILD_DIR)/$(LEX61) $(COLOR)
